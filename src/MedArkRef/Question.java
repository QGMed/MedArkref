...
//	}
	...
	/**
	 * In order to keep track of all the bonuses/penalties given and how it influences results
	 * we keep track of every instance the medQScore is edited, why and how much.
	 * @param amount the bonus/penalty (+ or -)
	 * @param reason
     */
	public void editScore(double amount, String reason){
		rankReciept+= "("+amount+")		"+reason+"|";
		score+=amount;
	}
	...
	public double score; //assigned by QuestionRanker
	public double labelScore; //gold-standard label, used only during eval
	public List<Double> featureValueList;

	public String yield;
	public static List<String> featureNames;  //list of feature names, for internal bookkeeping
	public Tree tree; //output question parse tree
	public Tree sourceTree; //original parse of a sentence given as input to the entire system
	public Tree intermediateTree; //an optionally transformed or simplified copy of the source tree (the output of stage 1)
	public Tree answerPhraseTree;
	public Map<String, Double> featureMap;
	public int sourceSentenceNumber;
	public List<String> intermediateTreeSupersenses;

	public Object sourceDocument; //generic pointer to a document object (generic in order to avoid unneeded dependencies)
	public String sourceArticleName;
	public boolean ignore = false;
	protected static final long serialVersionUID = -1033671431880363286L;
