...
//		//MetaMapApi mmw =  new MetaMapApi("104.197.31.127");
...
//				aceM.myMention = myDoc.newMention(sent, null, mmw);
//				continue;
//			}
...
//
//			aceM.myMention = myDoc.newMention(sent, maxProjection, new MetaMapWrapper("104.197.31.127"));
